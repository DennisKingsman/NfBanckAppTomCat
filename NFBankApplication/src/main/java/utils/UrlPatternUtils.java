...
public class UrlPatternUtils {
    ...
    private static boolean hasUrlPattern(ServletContext servletContext, String urlPattern) {
        ...
        int i = urlPattern.lastIndexOf(46);
        if (i != -1) {
        ...
        logger.info("urlPattern is: " + urlPattern);
        logger.info("method hasUrlPattern in UrlPatternUtils.class has called");
    ...
    public static String getUrlPattern(HttpServletRequest request) {
        logger.info("method getUrlPattern in UrlPatternUtils.class has called. Getting Servlet Context from HttpServletRequest");
        ServletContext servletContext = request.getServletContext();
        String servletPath = request.getServletPath();
        String pathInfo = request.getPathInfo();
        logger.info("Servlet Context is " + servletContext.toString());
        logger.info("Select from ServletContext accompanying servletPath " + servletPath + " and pathInfo " + pathInfo);
